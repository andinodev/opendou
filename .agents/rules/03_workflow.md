...
* **Comprobación Mandatoria:** Ejecutar `powershell -ExecutionPolicy Bypass -File .\run_tests.ps1` (o `.\godot.cmd --headless --path . -s tests/test_runner_cli.gd`) y validar que el resultado sea 100% positivo (código de salida 0, 0 fallos, 0 errores de compilación).
