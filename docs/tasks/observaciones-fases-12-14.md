...
| C2 | Los cuatro nodos de la Fase 10 no tienen demo (guarda de cobertura con `EXPECTED_UNCOVERED`) | Fase 11 | Una demo «El estanque» (oyente bajo el agua, volumen de entorno, indicador, guardia que oye) en la Fase 15 o antes — **Pagada (Fase 16):** «La presa» instancia los cuatro nodos; `EXPECTED_UNCOVERED` = solo el 2D |
