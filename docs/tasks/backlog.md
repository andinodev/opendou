...
* [x] `TASK-038.1`: **Panel Paramétrico de Salas en `OpenDouConvolutionGraphNode`:**
  * Controles de dimensiones físicas (Largo, Ancho, Alto en metros).
* [x] `TASK-038.2`: **Materiales y Coeficientes de Absorción:**
  * Selección de materiales acústicos (Madera, Concreto, Vidrio, Metal) y cálculo de tiempo de reverberación `RT60`.
* [x] `TASK-038.3`: **Síntesis Procedural Inmediata de IR:**
...
* [x] `TASK-039.1`: **Radar / Visor 2D Acústico Integrado en el Dock:**
